...
class _VideoEditorState extends State<VideoEditor> {
  ...
  void _exportVideo() async {
    ...
    // NOTE: To use `-crf 1` and [VideoExportPreset] you need `ffmpeg_kit_flutter_min_gpl` package (with `ffmpeg_kit` only it won't work)
      ...
      onCompleted: (file) {
        print("VideoPlayerController.file(file!) ${VideoPlayerController.file(file!)}");
      ...
      AnimatedBuilder(
        ...
        builder: (_, __) {
          ...
          return Padding(
            ...
            child: Row(children: [
              Text(formatter(Duration(seconds: pos.toInt())),style: TextStyle(color: Colors.white),),
              const Expanded(child: SizedBox()),
              OpacityTransition(
                visible: _controller.isTrimming,
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  Text(formatter(Duration(seconds: start.toInt())),style: TextStyle(color: Colors.white),),
